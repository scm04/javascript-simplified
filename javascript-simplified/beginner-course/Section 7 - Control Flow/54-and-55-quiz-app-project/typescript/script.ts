...
const answers = Array.from(document.querySelectorAll(".answer")) as HTMLInputElement[]
const questions = Array.from(document.querySelectorAll(".question-item")) as HTMLLIElement[]
...
form.addEventListener("submit", e => {
	...
	selectedAnswers.forEach(a => {
		const question = a.closest(".question-item") as HTMLLIElement
